...
<template>
	<view class="container">
		...
		<uni-tag text="添加车辆" type="primary"  @click="toCreateCar" class="toCreateCar"></uni-tag>
    ...
    <!-- <uni-list> -->
        <uni-list :border="true">
           ...
           <uni-list-chat title=""  note=""   time="2020-02-02 20:20"  v-for="item in carList" :key="item.value">
                    <template v-slot:header>
                        <view class="flex flex-col">
                            <label class="uni-list-cell uni-list-cell-pd flex flex-col">
                                ...
                                <view>
                                    <view>
                                        <text class="chat-custom" style="margin-left: 10px;">{{item.number}}</text>
                                    </view>
                                    <view>
                                        <text class="chat-custom" style="margin-left: 10px;font-size: 14px;font-weight: 400;">装载量： {{item.capacity}}吨</text>
                                    </view>
                    ...
                    <view class="chat-custom-right">
                        ...
                        <text class="chat-custom-text" @click="deleteCarFn(item)" >删除车辆</text>
                        <text class="chat-custom-text" @click="editCarFn(item)" >编辑车辆</text>
...
<script>
import {queryCarList, delCar} from '@/request/api'
	export default {
		data() {
			return {
                avatarList: [],
